...
with open("taipei-attractions.json", "r", encoding="utf-8") as input:
    ...
    with userdb.cursor() as cursor:
        for each_spot in spotData:
            ...
            value = (each_spot["stitle"], each_spot["CAT2"], each_spot["xbody"], each_spot["address"].replace(" ",""), each_spot["info"], each_spot["MRT"], each_spot["latitude"], each_spot["longitude"], urlString)
